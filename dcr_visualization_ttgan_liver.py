...
synthetic_data_path = '/home/khyj/0. phd/TTGAN_dataset_final/syn_liver/synthetic_liver_CTGAN.csv'  
...
# === 4️⃣ min distance 분포 시각화 ===
plt.figure(figsize=(8, 5))
plt.hist(min_distances, bins=30, color='skyblue', edgecolor='black')
plt.axvline(mean_real_min_distance, color='red', linestyle='--', label='Mean real min distance')
plt.title('Distribution of Synthetic–Real Min Distances')
plt.xlabel('Min Distance')
plt.ylabel('Frequency')
plt.legend()
plt.tight_layout()
output_path = 'min_distance_distribution_ctgan_liver.png'
